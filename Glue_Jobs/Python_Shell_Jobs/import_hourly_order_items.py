...
merge_qry = """
            ...
            copy mysql_dwh_staging.order_items from 's3://ecommerce-db/order_items/current/order_items.csv'
            ...
            delete 
                ...
                where mysql_dwh.order_items.order_id = mysql_dwh_staging.order_items.order_id;
